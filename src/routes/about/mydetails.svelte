    ...
    <div class="aboutMe">
      <div class="aboutMePas">
        ...
        <p class="myDetails">
          ...
          the basics, I got into creating various projects. I created some basic
          projects and improved them over time. I started coding on my phone,
          and I created various projects using the SPCK editor.
          <br /><br />
